...
import { jsonError, jsonOk, type ApiMeta } from '@/shared/api/response';
import {
  enforceRateLimit,
  rateLimitHeaders,
  type RateLimitKey,
  type RateLimitResult,
} from '@/shared/api/rate-limit';
import { clientIp, hashIp, verifyCsrfToken } from '@/shared/auth/tokens';
import { getSession, toActor, CSRF_COOKIE, type SessionUser } from '@/shared/auth/session';
